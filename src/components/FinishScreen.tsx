  ...
  return (
    <div className="flex flex-col gap-3 pt-1 pb-1">
      <div className="flex justify-center">
        <span className="rounded-full bg-[#8b5cf6]/10 px-2 py-1 text-[0.6rem] font-semibold uppercase tracking-widest text-[#8b5cf6]">
          Quiz Complete
        </span>
      </div>
      ...
      >
        <p className="text-xs text-[#5c5978]">
          Your dominant intelligence type
        </p>
